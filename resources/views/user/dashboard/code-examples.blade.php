                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12 mb-4">
                            <p>
                                ...
                                В кодах пробелы НИКОГДА не ставятся! <br>
                            ...
                            <div class="table-responsive">
                                <table border="1" cellpadding="5">
                                    ...
                                    <tr>
                                        <td> $a^2b^3$ </td> <td> a$\verb'^'$2b$\verb'^'$3 </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td> $x_1=1$, $x_2=3$ <br> (если у уравнения только два корня) </td> <td> x1=1,x2=3 или x1=3,x2=1 или <br> 1,3 или 3,1 </td>
                                    </tr>
                                    <tr>
